...
cd linker-upgrade/
curl -LO https://github.com/linker-bot/linker-upgrader/releases/download/v0.0.2/linker-upgrader_0.0.2_linux_arm64.tar.gz
tar zxvf linker-upgrader_0.0.2_linux_arm64.tar.gz
